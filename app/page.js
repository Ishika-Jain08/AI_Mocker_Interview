  ...
  return (
    ...
    <div>
      ...
      <main className="min-h-screen">
            ...
            <nav className="flex flex-col sm:flex-row flex-wrap items-center justify-between mt-4 md:mt-0 space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              <div>
                <a
                  ...
                  <Github className='w-10 h-8 hover:text-blue-900 hover:font-bold transition-all '/>
                </a>
              </div>

              <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0">
                <a href="#features" className="text-lg text-gray-800 mx-2 md:mx-4 hover:text-blue-900 hover:font-bold transition-all">Features</a>
                <a href="#testimonials" className="text-lg text-gray-800 mx-2 md:mx-4 hover:text-blue-900 hover:font-bold transition-all">Testimonials</a>
                <a href="#contact" className="text-lg text-gray-800 mx-2 md:mx-4 hover:text-blue-900 hover:font-bold transition-all">Contact</a>
              </div>
            </nav>
          </div>
        </header>
        ...
        {/* Hero Section */}
        <section className="flex flex-col items-center justify-center text-center py-20  px-6 md:px-0">
          <h2 className="text-4xl md:text-5xl font-bold ">Your Personal AI Interview Coach</h2>
          <p className="mt-4 text-lg md:text-xl  ">Practice with AI-powered mock interviews and get personalized feedback</p>
          <div className="mt-6 flex flex-col md:flex-row">
            <a
              href="/dashboard"
              className="px-6 py-3 mb-4 md:mb-0 md:mr-4 text-lg  font-medium bg-blue-200 !text-primary-600 rounded-lg shadow-lg hover:bg-blue-100"
            >
              Get Started
            </a>
            <a
              href="#features"
              className="px-6 py-3 text-lg font-medium border border-blue-200 rounded-lg hover:bg-blue-100 hover:text-black-600"
            >
              Learn More
            </a>
          </div>
